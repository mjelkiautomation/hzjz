class IndikatorskiPokazateljiIzvorisniPage
{
    ...
    getVodikovSulfid()
    {
        return cy.get('#pills-3 > :nth-child(2) > .col-md-6 > :nth-child(41) > .hydra-text-box-wrapper > .hydra-text-box')
    }

    getZeljezoUkupno()
    {
        return cy.get('#pills-3 > :nth-child(2) > .col-md-6 > :nth-child(42) > .hydra-text-box-wrapper > .hydra-text-box')
    }

}

export default IndikatorskiPokazateljiIzvorisniPage;