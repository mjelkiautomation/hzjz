class MikrobioloskiPokazateljiMonitoringBPage
{
    ...
    getRota()
    {
        return cy.get('#pills-1 > :nth-child(2) > .col-md-6 > :nth-child(11) > .hydra-text-box-wrapper > .hydra-text-box')
    }

}

export default MikrobioloskiPokazateljiMonitoringBPage